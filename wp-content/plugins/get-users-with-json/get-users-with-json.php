<?php
/**
 * Plugin Name: Get Users Class with JSON
 *
...
class Get_Users_with_JSON
{
     ...
     */
    public function get_users(array $filters = array(), $context = 'edit', $page = 1)
    {
